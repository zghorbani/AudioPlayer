...
const FullControl = function () {
  ...
  function handleNext() {
    ...
    currentSrcIndex === 4
      ? 0
      : Number(currentSrcIndex) + 1;
      setCurrentSrcIndex(nextIndex);
    // const nextIndex =
    //   this.state.currentSrcIndex === 4
    //     ? 0
    //     : Number(this.state.currentSrcIndex) + 1;
  ...
  function handlePlus() {
    player.seek(this.state.seek + 10);
  ...
  return(
    <div className="full-control">
        ...
        <div class="handels">
          ...
          {/* <div>
            <div onClick={this.handleBefore}>
              ...
              >
                <path
                  d="M15.111 2c-.851 0-1.555.704-1.555 1.556V7.94L4.373 2.27C3.366 1.648 2 2.41 2 3.594v12.812c0 1.184 1.366 1.946 2.373 1.324l9.183-5.67v4.384c0 .852.704 1.556 1.555 1.556h1.333c.852 0 1.556-.704 1.556-1.556V3.556C18 2.704 17.296 2 16.444 2h-1.333z"
                  fill="#fff"
                ></path>
              </svg>
            </div>
        ...
        {/* <div className="toggles-mute">
          <div onClick={this.handleMuteToggle}>
            {this.state.mute ? (
              <svg
                width="20"
                height="20"
...
//       <div className="full-control">
//         <ReactHowler
//           src={this.sources[this.state.currentSrcIndex][0]}
//           playing={this.state.playing}
...
//         <div className="toggles-repeat">
//           <div onClick={this.handleLoopToggle}>
//             <svg
//               width="20"
//               height="20"
//               viewBox="0 0 20 20"
...
//             </div>
//             <div>{this.state.seek.toFixed(2)}</div>
//           </div>
//           <div className="seek">
//             <span className="slider-container">
//               <input
...
//             class="player-desktop__slider-container__slider mdc-slider"
//           >
//             <div class="mdc-slider__track-container">
//               <div
//                 class="mdc-slider__track"
//                 style="transform: scaleX(0.0072);"
//               ></div>
//             </div>
//             <div
//               class="mdc-slider__thumb-container"
//               style="transform: translateX(2.592px) translateX(-50%);"
//             >
...
//           </div>
//         </div>
//         {/* <Button onClick={this.handlePlus}>10+</Button> */}
...
//         {/* <Button onClick={this.handleMines}>10-</Button> */}
